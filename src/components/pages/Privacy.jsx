  ...
  return (
    <MainContent>
      ...
      <Typography>
        ...
        <b>tanie-graty.netlify.app</b> <br /> Operatorem serwisu oraz
        Administratorem danych osobowych jest: <b>IO-TG-23</b> <br />
        Adres kontaktowy poczty elektronicznej operatora:{" "}
        <b>io.tg23@interia.pl</b>
        <br />
        Operator jest Administratorem Twoich danych osobowych w odniesieniu do
        danych podanych dobrowolnie w Serwisie. <br /> Serwis wykorzystuje dane
        ...
        <ul>
          ...
          <li>Poprzez zapisywanie w urządzeniach końcowych tokenów.</li>
        </ul>
        <h6>2. Wybrane metody ochrony danych stosowane przez Operatora</h6>
        Dane osobowe przechowywane w bazie danych są zaszyfrowane w taki sposób,
        że jedynie posiadający Operator klucz może je odczytać. Dzięki temu dane
        są chronione na wypadek wykradzenia bazy danych z serwera. Hasła
        ...
        użytkowników. W serwisie jest stosowana autentykacja dwuskładnikowa, co
        stanowi dodatkową formę ochrony logowania do Serwisu. Istotnym elementem
        ochrony danych jest regularna aktualizacja wszelkiego oprogramowania,
        ...
        danych osobowych w celu wykonywania swoich obowiązków, firma hostingowa,
        firmy obsługująca mailingi, firmy obsługująca komunikaty SMS, firmy, z
        którymi Administrator współpracuje w zakresie marketingu własnego,
        kurierzy, ubezpieczyciele, kancelarie prawne i windykatorzy, banki,
        operatorzy płatności, organy publiczne. Twoje dane osobowe przetwarzane
        ...
        nie będą przetwarzane dłużej niż przez 3 lata. Przysługuje Ci prawo
        żądania od Administratora: dostępu do danych osobowych Ciebie
        dotyczących, ich sprostowania, usunięcia, ograniczenia przetwarzania,
        oraz przenoszenia danych. Przysługuje Ci prawo do złożenia sprzeciwu w
        zakresie przetwarzania wskazanego w pkt 3.3 c) wobec przetwarzania
        ...
        sprzeciwu nie będzie mogło być wykonane w przypadku istnienia ważnych
        ...
        Europejskiej.
        <h6>5. Informacje w formularzach</h6>
        ...
        <h6> 6. Logi Administratora</h6>
        Informacje zachowaniu użytkowników w serwisie mogą podlegać logowaniu.
        Dane te są wykorzystywane w celu administrowania serwisem. Zwróć także
        uwagę, że Polityka Prywatności, nawet najlepsza, jest tylko jednym z
        elementów Twojej troski o dane osobowe i prywatność użytkownika na
        stronie www. Ninijeszy tekst stanowi fragment wygenerowanej w sposób
        automatyczny informacji. Stanowi <b>TYLKO PRZYKŁAD</b> prawdziwej
